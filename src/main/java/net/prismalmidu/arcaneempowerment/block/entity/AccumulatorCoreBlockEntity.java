    ...
    private boolean findCraftingAltar(Level world, BlockPos controllerPos, int radius) {
        ...
        for (BlockPos targetPos : scanArea) {
            ...
            if (world.getBlockState(targetPos).is(ModBlocks.CRAFTING_ALTAR_T1.get()) ||
                    ...
                    world.getBlockState(targetPos).is(ModBlocks.CRAFTING_ALTAR_T3.get()) ||
                    world.getBlockState(targetPos).is(ModBlocks.CRAFTING_ALTAR_T4.get()) ||
                    world.getBlockState(targetPos).is(ModBlocks.CRAFTING_ALTAR_T5.get())
