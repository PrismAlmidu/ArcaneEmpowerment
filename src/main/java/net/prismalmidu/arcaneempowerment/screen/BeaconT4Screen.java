...
public class BeaconT4Screen extends AbstractContainerScreen<BeaconT4Menu> {

    private TextScrollPanel scrollPanel;

    private static final ResourceLocation TEXTURE =
            new ResourceLocation(ArcaneEmpowerment.MOD_ID, "textures/gui/beacon_t4_gui.png");

    public BeaconT4Screen(BeaconT4Menu menu, Inventory playerInventory, Component title) {
