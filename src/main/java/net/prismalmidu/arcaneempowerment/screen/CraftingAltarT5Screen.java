...
public class CraftingAltarT5Screen extends AbstractContainerScreen<CraftingAltarT5Menu> {
    private static final ResourceLocation TEXTURE =
            new ResourceLocation(ArcaneEmpowerment.MOD_ID, "textures/gui/crafting_altar_t5.png");
    public CraftingAltarT5Screen(CraftingAltarT5Menu pMenu, Inventory pPlayerInventory, Component pTitle) {
