...
public class VoidMinerT3Menu extends AbstractContainerMenu {
    public final VoidMinerT3BlockEntity blockEntity;
    ...
    public VoidMinerT3Menu(int containerId, Inventory inv, FriendlyByteBuf extraData) {
    ...
    public VoidMinerT3Menu(int containerId, Inventory inv, BlockEntity entity, ContainerData data) {
        super(ModMenuTypes.VOID_MINER_T3_MENU.get(), containerId);
        checkContainerDataCount(data, 5);
        this.blockEntity = (VoidMinerT3BlockEntity) entity;
