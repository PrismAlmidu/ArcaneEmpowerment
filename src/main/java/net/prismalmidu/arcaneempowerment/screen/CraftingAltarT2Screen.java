...
public class CraftingAltarT2Screen extends AbstractContainerScreen<CraftingAltarT2Menu> {
    private static final ResourceLocation TEXTURE =
            new ResourceLocation(ArcaneEmpowerment.MOD_ID, "textures/gui/crafting_altar_t2.png");
    public CraftingAltarT2Screen(CraftingAltarT2Menu pMenu, Inventory pPlayerInventory, Component pTitle) {
