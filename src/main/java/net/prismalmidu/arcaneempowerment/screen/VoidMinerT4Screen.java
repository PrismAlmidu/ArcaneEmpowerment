...
public class VoidMinerT4Screen extends AbstractContainerScreen<VoidMinerT4Menu> {
    // Points directly to your image asset layout location
    private static final ResourceLocation TEXTURE =
            new ResourceLocation(ArcaneEmpowerment.MOD_ID, "textures/gui/void_miner_t4.png");

    public VoidMinerT4Screen(VoidMinerT4Menu menu, Inventory inventory, Component title) {
