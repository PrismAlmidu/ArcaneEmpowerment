...
public class VoidMinerT5Screen extends AbstractContainerScreen<VoidMinerT5Menu> {
    // Points directly to your image asset layout location
    private static final ResourceLocation TEXTURE =
            new ResourceLocation(ArcaneEmpowerment.MOD_ID, "textures/gui/void_miner_t5.png");

    public VoidMinerT5Screen(VoidMinerT5Menu menu, Inventory inventory, Component title) {
