...
public class CraftingAltarT4Screen extends AbstractContainerScreen<CraftingAltarT4Menu> {
    private static final ResourceLocation TEXTURE =
            new ResourceLocation(ArcaneEmpowerment.MOD_ID, "textures/gui/crafting_altar_t4.png");
    public CraftingAltarT4Screen(CraftingAltarT4Menu pMenu, Inventory pPlayerInventory, Component pTitle) {
