...
public class CraftingAltarT3Screen extends AbstractContainerScreen<CraftingAltarT3Menu> {
    private static final ResourceLocation TEXTURE =
            new ResourceLocation(ArcaneEmpowerment.MOD_ID, "textures/gui/crafting_altar_t3.png");
    public CraftingAltarT3Screen(CraftingAltarT3Menu pMenu, Inventory pPlayerInventory, Component pTitle) {
