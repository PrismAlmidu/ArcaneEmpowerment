...
import net.prismalmidu.arcaneempowerment.block.entity.BeaconT3BlockEntity;

public class BeaconT3Menu extends AbstractContainerMenu {
    private final BeaconT3BlockEntity blockEntity;
    private final Level level;
    private final ContainerData data;

    // Client-side constructor (Called automatically by Forge network pipeline)
    public BeaconT3Menu(int id, Inventory inv, FriendlyByteBuf extraData) {
    ...
    public BeaconT3Menu(int id, Inventory inv, BlockEntity entity, ContainerData data) {
        super(ModMenuTypes.BEACON_T3_MENU.get(), id);
        ...
        if (entity instanceof BeaconT3BlockEntity beacon) {
    ...
    public boolean stillValid(Player player) {
        return stillValid(ContainerLevelAccess.create(level, blockEntity.getBlockPos()), player, ModBlocks.BEACON_T3.get());
    }
