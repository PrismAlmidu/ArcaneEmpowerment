...
public class CraftingAltarT4Menu extends AbstractContainerMenu {
    public final CraftingAltarT4BlockEntity blockEntity;
    private final Level level;
    private final ContainerData data;

    public CraftingAltarT4Menu(int pContainerId, Inventory inv, FriendlyByteBuf extraData) {
        this(pContainerId, inv,inv.player.level().getBlockEntity(extraData.readBlockPos()), new SimpleContainerData(5));
    }

    public CraftingAltarT4Menu(int pContainerId, Inventory inv, BlockEntity entity, ContainerData data) {
        super(ModMenuTypes.CRAFTING_ALTAR_T4_MENU.get(), pContainerId);
        checkContainerSize(inv, 10);
        blockEntity = ((CraftingAltarT4BlockEntity) entity);
    ...
    public boolean stillValid(Player pPlayer) {
        return stillValid(ContainerLevelAccess.create(level, blockEntity.getBlockPos()),
                pPlayer, ModBlocks.CRAFTING_ALTAR_T4.get());
    }
