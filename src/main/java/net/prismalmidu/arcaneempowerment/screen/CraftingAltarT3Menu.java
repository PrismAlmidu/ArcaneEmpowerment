...
public class CraftingAltarT3Menu extends AbstractContainerMenu {
    public final CraftingAltarT3BlockEntity blockEntity;
    private final Level level;
    private final ContainerData data;

    public CraftingAltarT3Menu(int pContainerId, Inventory inv, FriendlyByteBuf extraData) {
        this(pContainerId, inv,inv.player.level().getBlockEntity(extraData.readBlockPos()), new SimpleContainerData(5));
    }

    public CraftingAltarT3Menu(int pContainerId, Inventory inv, BlockEntity entity, ContainerData data) {
        super(ModMenuTypes.CRAFTING_ALTAR_T3_MENU.get(), pContainerId);
        checkContainerSize(inv, 10);
        blockEntity = ((CraftingAltarT3BlockEntity) entity);
    ...
    public boolean stillValid(Player pPlayer) {
        return stillValid(ContainerLevelAccess.create(level, blockEntity.getBlockPos()),
                pPlayer, ModBlocks.CRAFTING_ALTAR_T3.get());
    }
