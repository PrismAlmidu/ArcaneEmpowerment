...
public class VoidMinerT5Menu extends AbstractContainerMenu {
    public final VoidMinerT5BlockEntity blockEntity;
    ...
    public VoidMinerT5Menu(int containerId, Inventory inv, FriendlyByteBuf extraData) {
    ...
    public VoidMinerT5Menu(int containerId, Inventory inv, BlockEntity entity, ContainerData data) {
        super(ModMenuTypes.VOID_MINER_T5_MENU.get(), containerId);
        checkContainerDataCount(data, 5);
        this.blockEntity = (VoidMinerT5BlockEntity) entity;
