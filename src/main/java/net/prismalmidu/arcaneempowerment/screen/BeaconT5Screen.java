...
public class BeaconT5Screen extends AbstractContainerScreen<BeaconT5Menu> {

    private TextScrollPanel scrollPanel;

    private static final ResourceLocation TEXTURE =
            new ResourceLocation(ArcaneEmpowerment.MOD_ID, "textures/gui/beacon_t5_gui.png");

    public BeaconT5Screen(BeaconT5Menu menu, Inventory playerInventory, Component title) {
