...
public class VoidMinerT4Menu extends AbstractContainerMenu {
    public final VoidMinerT4BlockEntity blockEntity;
    ...
    public VoidMinerT4Menu(int containerId, Inventory inv, FriendlyByteBuf extraData) {
    ...
    public VoidMinerT4Menu(int containerId, Inventory inv, BlockEntity entity, ContainerData data) {
        super(ModMenuTypes.VOID_MINER_T4_MENU.get(), containerId);
        checkContainerDataCount(data, 5);
        this.blockEntity = (VoidMinerT4BlockEntity) entity;
