...
public class BeaconT4Menu extends AbstractContainerMenu {
    private final BeaconT4BlockEntity blockEntity;
    ...
    public boolean stillValid(Player player) {
        return stillValid(ContainerLevelAccess.create(level, blockEntity.getBlockPos()), player, ModBlocks.BEACON_T4.get());
    }
