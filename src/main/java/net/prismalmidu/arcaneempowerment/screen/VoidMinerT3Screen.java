...
public class VoidMinerT3Screen extends AbstractContainerScreen<VoidMinerT3Menu> {
    // Points directly to your image asset layout location
    private static final ResourceLocation TEXTURE =
            new ResourceLocation(ArcaneEmpowerment.MOD_ID, "textures/gui/void_miner_t3.png");

    public VoidMinerT3Screen(VoidMinerT3Menu menu, Inventory inventory, Component title) {
