    ...
    public static final RegistryObject<CreativeModeTab> ARCANEEMPOWERMENT_TAB = CREATIVE_MODE_TABS.register("arcaneempowerment_tab",
            () -> CreativeModeTab.builder().icon(() -> new ItemStack(ModItems.ARCANIUM_SHARD.get()))
                    ...
                    .displayItems((pParameters, pOutput) -> {
                        ...
                        pOutput.accept(ModItems.PERK_FOOD_T2.get());
                        pOutput.accept(ModItems.PERK_FOOD_T3.get());
                        pOutput.accept(ModItems.PERK_FOOD_T4.get());
                        pOutput.accept(ModItems.PERK_FOOD_T5.get());
                        ...
                        pOutput.accept(ModBlocks.CRAFTING_ALTAR_T3.get());
                        pOutput.accept(ModBlocks.CRAFTING_ALTAR_T4.get());
                        pOutput.accept(ModBlocks.CRAFTING_ALTAR_T5.get());

                        pOutput.accept(ModBlocks.VOID_MINER_T2.get());
                        pOutput.accept(ModBlocks.VOID_MINER_T3.get());
                        pOutput.accept(ModBlocks.VOID_MINER_T4.get());
                        pOutput.accept(ModBlocks.VOID_MINER_T5.get());

                        pOutput.accept(ModBlocks.BEACON_T3.get());
                        pOutput.accept(ModBlocks.BEACON_T4.get());
                        pOutput.accept(ModBlocks.BEACON_T5.get());

                        pOutput.accept(ModBlocks.ACCUMULATOR_CORE.get());

                        pOutput.accept(ModBlocks.TRANSMUTATION_ALTAR.get());
