...
public class ModPerkRegistry {
    ...
    static {
        ...
        REGISTRY.put("a5",  new PerkModifier(createCellUUID("a5"),  LazyOptional.of(() -> AttributeRegistry.CAST_SPEED.get()), 0.05D, Operation.MULTIPLY_BASE)); //Cast Speed +5%
        REGISTRY.put("a6",  new PerkModifier(createCellUUID("a6"),  LazyOptional.of(() -> AttributeRegistry.SPELL_EFFICIENCY.get()), 0.05D, Operation.MULTIPLY_BASE)); // Spell Efficiency +5%
        REGISTRY.put("a7",  new PerkModifier(createCellUUID("a7"),  LazyOptional.of(() -> AttributeRegistry.CAST_SPEED.get()), 0.05D, Operation.MULTIPLY_BASE)); //Cast Speed +5%
        REGISTRY.put("a8",  new PerkModifier(createCellUUID("a8"),  LazyOptional.of(() -> AttributeRegistry.MANA_REGEN.get()), 0.10D, Operation.MULTIPLY_BASE)); //Mana Regen +10%
        REGISTRY.put("a9",  new PerkModifier(createCellUUID("a9"),  LazyOptional.of(() -> AttributeRegistry.MANA_REGEN.get()), 0.10D, Operation.MULTIPLY_BASE)); //Mana Regen +10%
        REGISTRY.put("a10",  new PerkModifier(createCellUUID("a10"),  LazyOptional.of(() -> AttributeRegistry.SPELL_EFFICIENCY.get()), 0.05D, Operation.MULTIPLY_BASE)); // Spell Efficiency +5%
        ...
        REGISTRY.put("a20",  new PerkModifier(createCellUUID("a20"),  LazyOptional.of(() -> AttributeRegistry.SPELL_EFFICIENCY.get()), 0.05D, Operation.MULTIPLY_BASE)); // Spell Efficiency +5%
        REGISTRY.put("a21",  new PerkModifier(createCellUUID("a21"),  LazyOptional.of(() -> AttributeRegistry.CAST_SPEED.get()), 0.05D, Operation.MULTIPLY_BASE)); //Cast Speed +5%
        ...
        REGISTRY.put("b3",  new PerkModifier(createCellUUID("b3"),  LazyOptional.of(() -> ALObjects.Attributes.ARROW_VELOCITY.get()), 0.05D, Operation.MULTIPLY_BASE)); //Arrow Velocity +5%
        REGISTRY.put("b4",  new PerkModifier(createCellUUID("b4"),  LazyOptional.of(() -> ALObjects.Attributes.DRAW_SPEED.get()), 0.05D, Operation.MULTIPLY_BASE)); //Draw Speed +5%
        REGISTRY.put("b5",  new PerkModifier(createCellUUID("b5"),  LazyOptional.of(() -> ALObjects.Attributes.ARROW_VELOCITY.get()), 0.05D, Operation.MULTIPLY_BASE)); //Arrow Velocity +5%
        REGISTRY.put("b6",  new PerkModifier(createCellUUID("b6"),  LazyOptional.of(() -> ALObjects.Attributes.DRAW_SPEED.get()), 0.05D, Operation.MULTIPLY_BASE)); //Draw Speed +5%
        REGISTRY.put("b7",  new PerkModifier(createCellUUID("b7"),  LazyOptional.of(() -> ALObjects.Attributes.ARROW_VELOCITY.get()), 0.05D, Operation.MULTIPLY_BASE)); //Arrow Velocity +5%
        REGISTRY.put("b8",  new PerkModifier(createCellUUID("b8"),  LazyOptional.of(() -> AttributeRegistry.MANA_REGEN.get()), 0.10D, Operation.MULTIPLY_BASE)); //Mana Regen +10%
        REGISTRY.put("b9",  new PerkModifier(createCellUUID("b9"),  LazyOptional.of(() -> AttributeRegistry.MANA_REGEN.get()), 0.10D, Operation.MULTIPLY_BASE)); //Mana Regen +10%
        REGISTRY.put("b10",  new PerkModifier(createCellUUID("b10"),  LazyOptional.of(() -> ALObjects.Attributes.DRAW_SPEED.get()), 0.05D, Operation.MULTIPLY_BASE)); //Draw Speed +5%
        REGISTRY.put("b11",  new PerkModifier(createCellUUID("b11"),  LazyOptional.of(() -> ALObjects.Attributes.ARROW_VELOCITY.get()), 0.05D, Operation.MULTIPLY_BASE)); //Arrow Velocity +5%
        REGISTRY.put("b12",  new PerkModifier(createCellUUID("b12"),  LazyOptional.of(() -> ALObjects.Attributes.DRAW_SPEED.get()), 0.05D, Operation.MULTIPLY_BASE)); //Draw Speed +5%
        REGISTRY.put("b13",  new PerkModifier(createCellUUID("b13"),  LazyOptional.of(() -> ALObjects.Attributes.ARROW_VELOCITY.get()), 0.05D, Operation.MULTIPLY_BASE)); //Arrow Velocity +5%
        REGISTRY.put("b14",  new PerkModifier(createCellUUID("b14"),  LazyOptional.of(() -> ALObjects.Attributes.ARROW_DAMAGE.get()), 0.05D, Operation.MULTIPLY_BASE)); // Arrow Damage +5%
        REGISTRY.put("b15",  new PerkModifier(createCellUUID("b15"),  LazyOptional.of(() -> ALObjects.Attributes.ARROW_DAMAGE.get()), 0.05D, Operation.MULTIPLY_BASE)); // Arrow Damage +5%
        ...
        REGISTRY.put("b20",  new PerkModifier(createCellUUID("b20"),  LazyOptional.of(() -> ALObjects.Attributes.DRAW_SPEED.get()), 0.05D, Operation.MULTIPLY_BASE)); //Draw Speed +5%
        REGISTRY.put("b21",  new PerkModifier(createCellUUID("b21"),  LazyOptional.of(() -> ALObjects.Attributes.ARROW_VELOCITY.get()), 0.05D, Operation.MULTIPLY_BASE)); //Arrow Velocity +5%
        REGISTRY.put("b22",  new PerkModifier(createCellUUID("b22"),  LazyOptional.of(() -> AttributeRegistry.MAX_MANA.get()), 100.0D, Operation.ADDITION)); // Max Mana +100
        ...
        REGISTRY.put("b24",  new PerkModifier(createCellUUID("b24"),  LazyOptional.of(() -> AttributeRegistry.MAX_MANA.get()), 100.0D, Operation.ADDITION)); // Max Mana +100
        REGISTRY.put("b25",  new PerkModifier(createCellUUID("b25"),  LazyOptional.of(() -> ALObjects.Attributes.DRAW_SPEED.get()), 0.10D, Operation.MULTIPLY_BASE)); //Draw Speed +10%
        REGISTRY.put("b26",  new PerkModifier(createCellUUID("b26"),  LazyOptional.of(() -> ALObjects.Attributes.ARROW_DAMAGE.get()), 0.05D, Operation.MULTIPLY_BASE)); // Arrow Damage +5%
        REGISTRY.put("b27",  new PerkModifier(createCellUUID("b27"),  LazyOptional.of(() -> ALObjects.Attributes.ARROW_VELOCITY.get()), 0.10D, Operation.MULTIPLY_BASE)); //Arrow Velocity +10%
        REGISTRY.put("b28",  new PerkModifier(createCellUUID("b28"),  LazyOptional.of(() -> ALObjects.Attributes.ARROW_DAMAGE.get()), 0.10D, Operation.MULTIPLY_BASE)); // Arrow Damage +10%
        REGISTRY.put("b29",  new PerkModifier(createCellUUID("b29"),  LazyOptional.of(() -> ALObjects.Attributes.ARROW_DAMAGE.get()), 0.10D, Operation.MULTIPLY_BASE)); // Arrow Damage +10%
        REGISTRY.put("b30",  new PerkModifier(createCellUUID("b30"),  LazyOptional.of(() -> ALObjects.Attributes.ARROW_DAMAGE.get()), 0.10D, Operation.MULTIPLY_BASE)); // Arrow Damage +10%
        ...
        REGISTRY.put("c8",  new PerkModifier(createCellUUID("c8"),  LazyOptional.of(() -> AttributeRegistry.MANA_REGEN.get()), 0.10D, Operation.MULTIPLY_BASE)); //Mana Regen +10%
        REGISTRY.put("c9",  new PerkModifier(createCellUUID("c9"),  LazyOptional.of(() -> AttributeRegistry.MANA_REGEN.get()), 0.10D, Operation.MULTIPLY_BASE)); //Mana Regen +10%
        ...
        REGISTRY.put("c22",  new PerkModifier(createCellUUID("c22"),  LazyOptional.of(() -> AttributeRegistry.MAX_MANA.get()), 100.0D, Operation.ADDITION)); // Max Mana +100
        ...
        REGISTRY.put("c24",  new PerkModifier(createCellUUID("c24"),  LazyOptional.of(() -> AttributeRegistry.MAX_MANA.get()), 100.0D, Operation.ADDITION)); // Max Mana +100
        ...
        REGISTRY.put("e1",  new PerkModifier(createCellUUID("e1"),  LazyOptional.of(() -> AttributeRegistry.MAX_MANA.get()), 100.0D, Operation.ADDITION)); // Max Mana +100
        REGISTRY.put("e2",  new PerkModifier(createCellUUID("e2"),  LazyOptional.of(() -> AttributeRegistry.MAX_MANA.get()), 100.0D, Operation.ADDITION)); // Max Mana +100
        REGISTRY.put("e3",  new PerkModifier(createCellUUID("e3"),  LazyOptional.of(() -> ALObjects.Attributes.CRIT_DAMAGE.get()), 0.25D, Operation.MULTIPLY_BASE)); //Crit Damage +25%
        REGISTRY.put("e4",  new PerkModifier(createCellUUID("e4"),  LazyOptional.of(() -> ALObjects.Attributes.LIFE_STEAL.get()), 0.01D, Operation.MULTIPLY_BASE)); //Life Steal +1%
        REGISTRY.put("e5",  new PerkModifier(createCellUUID("e5"),  LazyOptional.of(() -> ALObjects.Attributes.LIFE_STEAL.get()), 0.01D, Operation.MULTIPLY_BASE)); //Life Steal +1%
        REGISTRY.put("e6",  new PerkModifier(createCellUUID("e7"),  LazyOptional.of(() -> ALObjects.Attributes.CRIT_CHANCE.get()), 0.02D, Operation.MULTIPLY_BASE)); //Crit Chance +2%
        REGISTRY.put("e7",  new PerkModifier(createCellUUID("e6"),  LazyOptional.of(() -> ALObjects.Attributes.CRIT_CHANCE.get()), 0.02D, Operation.MULTIPLY_BASE)); //Crit Chance +2%
        REGISTRY.put("e8",  new PerkModifier(createCellUUID("e8"),  LazyOptional.of(() -> ALObjects.Attributes.CRIT_DAMAGE.get()), 0.25D, Operation.MULTIPLY_BASE)); //Crit Damage +25%
        REGISTRY.put("e9",  new PerkModifier(createCellUUID("e9"),  LazyOptional.of(() -> ALObjects.Attributes.CRIT_CHANCE.get()), 0.02D, Operation.MULTIPLY_BASE)); //Crit Chance +2%
        REGISTRY.put("e10",  new PerkModifier(createCellUUID("e10"),  LazyOptional.of(() -> ALObjects.Attributes.CRIT_CHANCE.get()), 0.02D, Operation.MULTIPLY_BASE)); //Crit Chance +2%
        REGISTRY.put("e11",  new PerkModifier(createCellUUID("e11"),  LazyOptional.of(() -> ALObjects.Attributes.CRIT_DAMAGE.get()), 0.10D, Operation.MULTIPLY_BASE)); //Crit Damage +10%
        REGISTRY.put("e12",  new PerkModifier(createCellUUID("e12"),  LazyOptional.of(() -> ALObjects.Attributes.COLD_DAMAGE.get()), 5.0D, Operation.ADDITION)); // Cold Damage +5

        REGISTRY.put("f1",  new PerkModifier(createCellUUID("f1"),  LazyOptional.of(() -> ALObjects.Attributes.CRIT_CHANCE.get()), 0.02D, Operation.MULTIPLY_BASE)); //Crit Chance +2%
        REGISTRY.put("f2",  new PerkModifier(createCellUUID("f2"),  LazyOptional.of(() -> ALObjects.Attributes.CRIT_CHANCE.get()), 0.02D, Operation.MULTIPLY_BASE)); //Crit Chance +2%
        REGISTRY.put("f3",  new PerkModifier(createCellUUID("f3"),  LazyOptional.of(() -> ALObjects.Attributes.LIFE_STEAL.get()), 0.05D, Operation.MULTIPLY_BASE)); //Life Steal +5%
        REGISTRY.put("f4",  new PerkModifier(createCellUUID("f4"),  LazyOptional.of(() -> AttributeRegistry.MAX_MANA.get()), 100.0D, Operation.ADDITION)); // Max Mana +100
        REGISTRY.put("f5",  new PerkModifier(createCellUUID("f5"),  LazyOptional.of(() -> AttributeRegistry.MAX_MANA.get()), 100.0D, Operation.ADDITION)); // Max Mana +100
        ...
        REGISTRY.put("f8",  new PerkModifier(createCellUUID("f8"),  LazyOptional.of(() -> ALObjects.Attributes.LIFE_STEAL.get()), 0.05D, Operation.MULTIPLY_BASE)); //Life Steal +5%
        REGISTRY.put("f9",  new PerkModifier(createCellUUID("f9"),  LazyOptional.of(() -> ALObjects.Attributes.LIFE_STEAL.get()), 0.01D, Operation.MULTIPLY_BASE)); //Life Steal +1%
        REGISTRY.put("f10",  new PerkModifier(createCellUUID("f10"),  LazyOptional.of(() -> ALObjects.Attributes.LIFE_STEAL.get()), 0.01D, Operation.MULTIPLY_BASE)); //Life Steal +1%
        REGISTRY.put("f11",  new PerkModifier(createCellUUID("f11"),  LazyOptional.of(() -> ALObjects.Attributes.LIFE_STEAL.get()), 0.01D, Operation.MULTIPLY_BASE)); //Life Steal +1%
        REGISTRY.put("f12",  new PerkModifier(createCellUUID("f12"),  LazyOptional.of(() -> ALObjects.Attributes.FIRE_DAMAGE.get()), 5.0D, Operation.ADDITION)); // Fire Damage +5
        ...
        REGISTRY.put("h6",  new PerkModifier(createCellUUID("h6"),  LazyOptional.of(() -> AttributeRegistry.MAX_MANA.get()), 100.0D, Operation.ADDITION)); // Max Mana +100
        REGISTRY.put("h7",  new PerkModifier(createCellUUID("h7"),  LazyOptional.of(() -> AttributeRegistry.MAX_MANA.get()), 100.0D, Operation.ADDITION)); // Max Mana +100
        REGISTRY.put("h8",  new PerkModifier(createCellUUID("h8"),  LazyOptional.of(() -> AttributeRegistry.MAX_MANA.get()), 200.0D, Operation.ADDITION)); // Max Mana +200
        REGISTRY.put("h9",  new PerkModifier(createCellUUID("h9"),  LazyOptional.of(() -> AttributeRegistry.MAX_MANA.get()), 100.0D, Operation.ADDITION)); // Max Mana +100
        REGISTRY.put("h10",  new PerkModifier(createCellUUID("h10"),  LazyOptional.of(() -> AttributeRegistry.MAX_MANA.get()), 100.0D, Operation.ADDITION)); // Max Mana +100
        REGISTRY.put("h11",  new PerkModifier(createCellUUID("h11"),  LazyOptional.of(() -> AttributeRegistry.MAX_MANA.get()), 100.0D, Operation.ADDITION)); // Max Mana +100
        REGISTRY.put("h12",  new PerkModifier(createCellUUID("h12"),  LazyOptional.of(() -> AttributeRegistry.MAX_MANA_MULTIPLIER_FINAL.get()), 0.20D, Operation.MULTIPLY_BASE)); //Max Mana Multiplier Final +20%
        ...
        REGISTRY.put("i5",  new PerkModifier(createCellUUID("i5"),  LazyOptional.of(() -> AttributeRegistry.MAX_MANA.get()), 200.0D, Operation.ADDITION)); // Max Mana +200
        REGISTRY.put("i6",  new PerkModifier(createCellUUID("i6"),  LazyOptional.of(() -> AttributeRegistry.MAX_MANA.get()), 100.0D, Operation.ADDITION)); // Max Mana +100
        REGISTRY.put("i7",  new PerkModifier(createCellUUID("i7"),  LazyOptional.of(() -> AttributeRegistry.MAX_MANA.get()), 100.0D, Operation.ADDITION)); // Max Mana +100
        REGISTRY.put("i8",  new PerkModifier(createCellUUID("i9"),  LazyOptional.of(() -> Attributes.ARMOR), 1.0D, Operation.ADDITION));          // Armor +1
        REGISTRY.put("i9", new PerkModifier(createCellUUID("i10"), LazyOptional.of(() -> Attributes.MAX_HEALTH), 12.0D, Operation.ADDITION));  // Max Health +12
        REGISTRY.put("i10", new PerkModifier(createCellUUID("i11"), LazyOptional.of(() -> Attributes.MAX_HEALTH), 4.0D, Operation.ADDITION));  // Max Health +4
        REGISTRY.put("i11", new PerkModifier(createCellUUID("i12"), LazyOptional.of(() -> Attributes.MAX_HEALTH), 4.0D, Operation.ADDITION));  // Max Health +4
        REGISTRY.put("i12",  new PerkModifier(createCellUUID("i13"),  LazyOptional.of(() -> Attributes.ARMOR), 1.0D, Operation.ADDITION));          // Armor +1
        REGISTRY.put("i13",  new PerkModifier(createCellUUID("i14"),  LazyOptional.of(() -> AttributeRegistry.MAX_MANA.get()), 200.0D, Operation.ADDITION)); // Max Mana +200
        REGISTRY.put("i14",  new PerkModifier(createCellUUID("i14"),  LazyOptional.of(() -> AttributeRegistry.MAX_MANA.get()), 100.0D, Operation.ADDITION)); // Max Mana +100
        REGISTRY.put("i15",  new PerkModifier(createCellUUID("i15"),  LazyOptional.of(() -> AttributeRegistry.MAX_MANA.get()), 100.0D, Operation.ADDITION)); // Max Mana +100
